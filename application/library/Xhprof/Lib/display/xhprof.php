...
//
global $description,$description1,$description2,$descriptions;
global $vbar, $vwbar, $vwlbar, $vbbar, $vrbar, $vgbar,$base_path;
 ...
 */
$base_path = rtrim(dirname($_SERVER['SCRIPT_NAME']), '/\\').'/analysis';
...
function symbol_report($url_params,
  ...
  $callgraph_href = "$base_path/graph?"
